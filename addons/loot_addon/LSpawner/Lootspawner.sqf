...
_chfullfuel = 50;					//Chance (in %) of a spawned fuelcan to be full instead of empty
...
_chperSpot = 90;					//Chance (in %) if a spot gets loot. Will be considered before 'spawnClassChance_list'
...
[0, 30, 25, 24, 18, 22],	// civil
[1, 50, 40, 18, 15, 32],	// military
[2, 25, 29, 32, 38, 25],	// industrial
[3, 20, 35, 39, -1, -1]		// research
];
