if(isServer) then {
	...
	diag_log 		format["WAI: [Mission: Underwater Treasure Hunt]: Starting... %1",_position];
	...
	_complete = [
		...
		"Scouts have observed an Osprey crashing into the sea, watch out for sharks!",	// mission announcement
