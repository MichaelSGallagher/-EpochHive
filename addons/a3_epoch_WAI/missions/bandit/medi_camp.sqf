...
if(isServer) then {
	...
	_base2 = createVehicle ["Land_ToiletBox_F",[(_position select 0) + 6.3374, (_position select 1) - 11.1944,0],[], 0, "CAN_COLLIDE"];
	...
	_complete = [
		...
		"An renegade force has set up a medical re-supply camp! Check your map for the location!",	// mission announcement
