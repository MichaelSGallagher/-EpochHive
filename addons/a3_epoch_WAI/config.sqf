if(isServer) then {
	...
	/* GENERAL CONFIG */
		...
		blacklist					= [
			...
			// Tanoa
			[[01400,11300,0],[02700,11000,0]], 	// Western Trader Camp
			[[11100,13700,0],[12400,12300,0]], 	// Eastern Trader Camp
			[[04200,06000,0],[05500,04500,0]]	// Southern Trader Camp
		];
	/* END GENERAL CONFIG */
	...
	/* AI CONFIG */
		...
		ai_skill_easy				= [["aimingAccuracy",0.20],["aimingShake",0.50],["aimingSpeed",0.50],["spotDistance",0.50],["spotTime",0.50],["courage",1.00],["reloadSpeed",1.00],["commanding",1.00],["general",0.50]];	// Easy
		ai_skill_random				= [ai_skill_extreme,ai_skill_hard,ai_skill_hard,ai_skill_hard,ai_skill_hard,ai_skill_medium,ai_skill_medium,ai_skill_medium,ai_skill_medium,ai_skill_easy];

		ai_static_useweapon			= true;	// Allows AI on static guns to have a loadout 	
		ai_static_weapons			= ["B_HMG_01_F","B_HMG_01_high_F","B_Mortar_01_F"];	// static guns 
	...
	/* WAI MISSIONS CONFIG */
		...
		// Vehicle arrays
		armed_vehicle 				= ["B_MRAP_01_hmg_F"]; 
		armed_chopper 				= ["B_Heli_Transport_01_camo_F"];
		refuel_trucks				= ["B_Truck_01_fuel_F"];
