...
class CfgEpoch
{
	class Default
	{
		...
		allowedVehiclesList[] = {
			{"I_mas_T72_AAF_01",3},
            {"I_mas_T72B_Early_AAF_01",3},
            {"I_mas_T72B_AAF_01",3},
            {"I_mas_T72BM_AAF_01",3},
            {"I_mas_T55_AAF_01",3},
            {"I_mas_T34_AAF_01",3},
            {"I_mas_ZSU_AAF_01",3},
            {"O_mas_T72_OPF_01",3},
            {"O_mas_T72B_Early_OPF_01",3},
            {"O_mas_T72B_OPF_01",3},
            {"O_mas_T72BM_OPF_01",3},
            {"O_mas_T55_OPF_01",3},
            {"O_mas_ZSU_OPF_01",3},
            {"B_mas_CH_47F",3},
            {"B_mas_UH1Y_F",3},
            ...
            {"I_mas_MI24V",3},
            {"O_mas_MI24V",3},
            {"B_mas_cars_LR_Unarmed",3},
            {"B_mas_cars_LR_Med",3},
            {"B_mas_cars_LR_M2",3},
            {"B_mas_cars_LR_Mk19",3},
            {"B_mas_cars_LR_TOW",3},
            {"B_mas_cars_LR_Stinger",3},
            {"B_mas_cars_LR_SPG9",3},
            {"I_mas_cars_LR_soft_Unarmed",3},
            {"I_mas_cars_LR_soft_Med",3},
            {"I_mas_cars_LR_soft_M2",3},
            {"I_mas_cars_LR_soft_Mk19",3},
            {"I_mas_cars_LR_soft_TOW",3},
            {"I_mas_cars_LR_soft_Stinger",3},
            {"I_mas_cars_LR_soft_SPG9",3},
